  ...
  return (
    <div className="RecCountiner p-4">
      <div className="RecHead">
        ...
        <h4 className="text-light">Recorder</h4>
      ...
      <div className="RecMain">
        <div className="degPlay">
          ...
          <div className=" timing">
            {
              recordStatus === "" && <h6 className="text-light">Ready to Record</h6>
            }
            {
      ...
      <div className="Recfooter">
        ...
        />
        {
          recordStatus !== "recording"
          &&
          <button className="btn border-0 text-light d-block mx-auto mt-2" onClick={() => { setRecordStatus(""); stopTimer() }}>Restart</button>
        }
        <button className="btn btn-primary d-block mx-auto mt-auto" onClick={() => props.setShowModalWallet("action")}>Send voice to Areon</button>
      </div>
    </div>
  )
}